      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          <a
            ...
            className="px-8 py-3.5 bg-accent hover:bg-accent-dim text-white text-sm font-medium rounded-lg transition-colors duration-200 inline-flex items-center justify-center gap-2"
          >
            <svg
              className="w-4 h-4"
              fill="none"
